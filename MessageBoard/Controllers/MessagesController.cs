...
namespace MessageBoard.Controllers
{
  ...
  public class MessagesController : ControllerBase
  {
    ...
    // POST: api/Messages
    // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
    [HttpPost("{groupId}/createmessage")]
    public async Task<ActionResult<Message>> PostMessage(Message message, int groupId)
    {
      var thisGroup = _db.Groups.Include(entry => entry.Messages).FirstOrDefault(entry => entry.GroupId == groupId);
